...
const names = ["John","Diane","Phil","Nathan","Matt","Matthew","Rick","Richard","Bill","Billy","Manny","Opal","David","June","Steve","Zachary","Jeremiah","Sebastian","Harrison","Kenneth","Brayden","Karen","Clara","Amy","Debra","Betty","Jeremy","joel",];
...
const headlines=[`${names[random(names.length)]} ${lastname[random(names.length)]} ${problems[random(problems.length)]} on ${times[random(times.length)]}, and you won't guess what happened next`]
const Lead = []
const body = []
const conclusions = []
const images = []
